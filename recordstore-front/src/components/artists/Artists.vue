<template>
  <div class="max-w-md m-auto py-10">
    ...
    <form action="" @submit.prevent="addArtist">
      ...
      <input type="submit" value="Add Artist" class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" />
    </form>
